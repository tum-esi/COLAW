...
bool TrafficJamAhead::checkSlowVehiclesAheadByV2X() const
{
    ...
    //slowVehicles is the Predicate (the policy, like a function) which is passed to the count() function of the LDM
    //The count function returns the number of entries of the LDM that satisfy the predicate policy (e.g. slowVehicles)
